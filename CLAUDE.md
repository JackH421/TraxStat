...
│   ├── home.js             ~368 lines — HOMEPAGE_FEATURED, HOMEPAGE_ARTICLES (8 entries),
...
| Series  | Status                                                                 |
|---------|------------------------------------------------------------------------|
| Home    | Default landing view — news feed (2026-05-17). Featured carousel of recent winners across all series with completed results, championship snapshot for F1 + NASCAR, 8-card article feed. Video Highlights is a TODO hook for Session 5. See `js/home.js`. |
...
## Daily news aggregator (Session 5)
...
- **Mobile push**: same setup as Session 3 — GitHub mobile pushes a notification when the PR opens, no extra secrets needed.
