...
const HARDCODED_RACES={
  ...
  8:{round:'8',raceName:'Austrian Grand Prix',date:'2026-06-28',Circuit:{circuitName:'Red Bull Ring',Location:{country:'🇦🇹'}},
    Results:[
      {position:'1',Driver:{driverId:'russell',familyName:'Russell',nationality:'British'},Constructor:{name:'Mercedes'},points:'25',laps:'71',Time:{time:'1:26:37.979'},status:'Finished',FastestLap:{rank:'6',lap:'49',Time:{time:'1:10.683'}}},
      {position:'2',Driver:{driverId:'max_verstappen',familyName:'Verstappen',nationality:'Dutch'},Constructor:{name:'Red Bull'},points:'18',laps:'71',Time:{time:'+1.611'},status:'Finished',FastestLap:{rank:'2',lap:'57',Time:{time:'1:10.483'}}},
      {position:'3',Driver:{driverId:'antonelli',familyName:'Antonelli',nationality:'Italian'},Constructor:{name:'Mercedes'},points:'15',laps:'71',Time:{time:'+1.986'},status:'Finished',FastestLap:{rank:'1',lap:'59',Time:{time:'1:10.374'}}},
      {position:'4',Driver:{driverId:'piastri',familyName:'Piastri',nationality:'Australian'},Constructor:{name:'McLaren'},points:'12',laps:'71',Time:{time:'+21.809'},status:'Finished',FastestLap:{rank:'3',lap:'45',Time:{time:'1:10.595'}}},
      {position:'5',Driver:{driverId:'hamilton',familyName:'Hamilton',nationality:'British'},Constructor:{name:'Ferrari'},points:'10',laps:'71',Time:{time:'+26.393'},status:'Finished',FastestLap:{rank:'7',lap:'45',Time:{time:'1:10.946'}}},
      {position:'6',Driver:{driverId:'hadjar',familyName:'Hadjar',nationality:'French'},Constructor:{name:'Red Bull'},points:'8',laps:'71',Time:{time:'+29.399'},status:'Finished',FastestLap:{rank:'8',lap:'42',Time:{time:'1:10.947'}}},
      {position:'7',Driver:{driverId:'norris',familyName:'Norris',nationality:'British'},Constructor:{name:'McLaren'},points:'6',laps:'71',Time:{time:'+31.505'},status:'Finished',FastestLap:{rank:'5',lap:'55',Time:{time:'1:10.652'}}},
      {position:'8',Driver:{driverId:'leclerc',familyName:'Leclerc',nationality:'Monegasque'},Constructor:{name:'Ferrari'},points:'4',laps:'71',Time:{time:'+45.659'},status:'Finished',FastestLap:{rank:'4',lap:'67',Time:{time:'1:10.606'}}},
      {position:'9',Driver:{driverId:'lawson',familyName:'Lawson',nationality:'New Zealander'},Constructor:{name:'Racing Bulls'},points:'2',laps:'70',Time:{time:'+15.334'},status:'Lapped',FastestLap:{rank:'10',lap:'55',Time:{time:'1:11.547'}}},
      {position:'10',Driver:{driverId:'arvid_lindblad',familyName:'Lindblad',nationality:'British'},Constructor:{name:'Racing Bulls'},points:'1',laps:'70',Time:{time:'+19.030'},status:'Lapped',FastestLap:{rank:'11',lap:'56',Time:{time:'1:11.587'}}},
      {position:'11',Driver:{driverId:'bortoleto',familyName:'Bortoleto',nationality:'Brazilian'},Constructor:{name:'Audi'},points:'0',laps:'70',Time:{time:'+30.315'},status:'Lapped',FastestLap:{rank:'14',lap:'59',Time:{time:'1:11.866'}}},
      {position:'12',Driver:{driverId:'hulkenberg',familyName:'Hülkenberg',nationality:'German'},Constructor:{name:'Audi'},points:'0',laps:'70',Time:{time:'+38.484'},status:'Lapped',FastestLap:{rank:'12',lap:'55',Time:{time:'1:11.634'}}},
      {position:'13',Driver:{driverId:'gasly',familyName:'Gasly',nationality:'French'},Constructor:{name:'Alpine F1 Team'},points:'0',laps:'70',Time:{time:'+39.251'},status:'Lapped',FastestLap:{rank:'9',lap:'54',Time:{time:'1:11.466'}}},
      {position:'14',Driver:{driverId:'bearman',familyName:'Bearman',nationality:'British'},Constructor:{name:'Haas F1 Team'},points:'0',laps:'70',Time:{time:'+1:02.677'},status:'Lapped',FastestLap:{rank:'15',lap:'54',Time:{time:'1:12.207'}}},
      {position:'15',Driver:{driverId:'colapinto',familyName:'Colapinto',nationality:'Argentine'},Constructor:{name:'Alpine F1 Team'},points:'0',laps:'70',Time:{time:'+1:05.647'},status:'Lapped',FastestLap:{rank:'13',lap:'49',Time:{time:'1:11.795'}}},
      {position:'16',Driver:{driverId:'ocon',familyName:'Ocon',nationality:'French'},Constructor:{name:'Haas F1 Team'},points:'0',laps:'69',Time:{time:'+25.932'},status:'Lapped',FastestLap:{rank:'17',lap:'37',Time:{time:'1:12.979'}}},
      {position:'17',Driver:{driverId:'albon',familyName:'Albon',nationality:'Thai'},Constructor:{name:'Williams'},points:'0',laps:'69',Time:{time:'+28.082'},status:'Lapped',FastestLap:{rank:'18',lap:'43',Time:{time:'1:13.137'}}},
      {position:'18',Driver:{driverId:'alonso',familyName:'Alonso',nationality:'Spanish'},Constructor:{name:'Aston Martin'},points:'0',laps:'68',Time:{time:'+4.833'},status:'Lapped',FastestLap:{rank:'16',lap:'52',Time:{time:'1:12.501'}}},
      {position:'R',Driver:{driverId:'stroll',familyName:'Stroll',nationality:'Canadian'},Constructor:{name:'Aston Martin'},points:'0',laps:'45',status:'Retired',FastestLap:{rank:'20',lap:'30',Time:{time:'1:13.796'}}},
      {position:'R',Driver:{driverId:'sainz',familyName:'Sainz',nationality:'Spanish'},Constructor:{name:'Williams'},points:'0',laps:'23',status:'Retired',FastestLap:{rank:'19',lap:'22',Time:{time:'1:13.694'}}},
      {position:'R',Driver:{driverId:'perez',familyName:'Pérez',nationality:'Mexican'},Constructor:{name:'Cadillac F1 Team'},points:'0',laps:'4',status:'Retired',FastestLap:{rank:'21',lap:'3',Time:{time:'1:14.448'}}},
      {position:'R',Driver:{driverId:'bottas',familyName:'Bottas',nationality:'Finnish'},Constructor:{name:'Cadillac F1 Team'},points:'0',laps:'2',status:'Retired'},
    ]}
};
...
const HARDCODED_DRIVER_STANDINGS=[
  {position:'1',points:'171',Driver:{driverId:'antonelli',familyName:'Antonelli',givenName:'Andrea Kimi',nationality:'Italian'},Constructors:[{name:'Mercedes'}]},
  {position:'2',points:'131',Driver:{driverId:'russell',familyName:'Russell',givenName:'George',nationality:'British'},Constructors:[{name:'Mercedes'}]},
  {position:'3',points:'125',Driver:{driverId:'hamilton',familyName:'Hamilton',givenName:'Lewis',nationality:'British'},Constructors:[{name:'Ferrari'}]},
  {position:'4',points:'80',Driver:{driverId:'piastri',familyName:'Piastri',givenName:'Oscar',nationality:'Australian'},Constructors:[{name:'McLaren'}]},
  {position:'5',points:'79',Driver:{driverId:'norris',familyName:'Norris',givenName:'Lando',nationality:'British'},Constructors:[{name:'McLaren'}]},
  {position:'6',points:'79',Driver:{driverId:'leclerc',familyName:'Leclerc',givenName:'Charles',nationality:'Monegasque'},Constructors:[{name:'Ferrari'}]},
  {position:'7',points:'73',Driver:{driverId:'max_verstappen',familyName:'Verstappen',givenName:'Max',nationality:'Dutch'},Constructors:[{name:'Red Bull'}]},
  {position:'8',points:'42',Driver:{driverId:'hadjar',familyName:'Hadjar',givenName:'Isack',nationality:'French'},Constructors:[{name:'Red Bull'}]},
  {position:'9',points:'41',Driver:{driverId:'gasly',familyName:'Gasly',givenName:'Pierre',nationality:'French'},Constructors:[{name:'Alpine F1 Team'}]},
  {position:'10',points:'30',Driver:{driverId:'lawson',familyName:'Lawson',givenName:'Liam',nationality:'New Zealander'},Constructors:[{name:'Racing Bulls'}]},
  ...
  {position:'13',points:'14',Driver:{driverId:'arvid_lindblad',familyName:'Lindblad',givenName:'Arvid',nationality:'British'},Constructors:[{name:'Racing Bulls'}]},
...
const HARDCODED_CONSTRUCTOR_STANDINGS=[
  {position:'1',points:'302',Constructor:{name:'Mercedes',nationality:'German'}},
  {position:'2',points:'204',Constructor:{name:'Ferrari',nationality:'Italian'}},
  {position:'3',points:'159',Constructor:{name:'McLaren',nationality:'British'}},
  {position:'4',points:'115',Constructor:{name:'Red Bull',nationality:'Austrian'}},
  {position:'5',points:'57',Constructor:{name:'Alpine F1 Team',nationality:'French'}},
  {position:'6',points:'44',Constructor:{name:'Racing Bulls',nationality:'Italian'}},
