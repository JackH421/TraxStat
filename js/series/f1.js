...
const HARDCODED_RACES={
  ...
  6:{round:'6',raceName:'Monaco Grand Prix',date:'2026-06-07',Circuit:{circuitName:'Circuit de Monaco',Location:{country:'🇲🇨'}},
    Results:[
      {position:'1',Driver:{driverId:'antonelli',familyName:'Antonelli',nationality:'Italian'},Constructor:{name:'Mercedes'},points:'25',laps:'78',Time:{time:'2:23:31.243'},status:'Finished'},
      ...
      {position:'6',Driver:{driverId:'arvid_lindblad',familyName:'Lindblad',nationality:'British'},Constructor:{name:'Racing Bulls'},points:'8',laps:'78',Time:{time:'+29.010'},status:'Finished'},
      {position:'7',Driver:{driverId:'gasly',familyName:'Gasly',nationality:'French'},Constructor:{name:'Alpine F1 Team'},points:'6',laps:'78',Time:{time:'+30.369'},status:'Finished'},
      ...
      {position:'10',Driver:{driverId:'perez',familyName:'Pérez',nationality:'Mexican'},Constructor:{name:'Cadillac F1 Team'},points:'1',laps:'78',Time:{time:'+39.153'},status:'Finished'},
      {position:'11',Driver:{driverId:'alonso',familyName:'Alonso',nationality:'Spanish'},Constructor:{name:'Aston Martin'},points:'0',laps:'78',Time:{time:'+41.899'},status:'Finished'},
      {position:'12',Driver:{driverId:'bortoleto',familyName:'Bortoleto',nationality:'Brazilian'},Constructor:{name:'Audi'},points:'0',laps:'78',Time:{time:'+42.748'},status:'Finished'},
      {position:'13',Driver:{driverId:'russell',familyName:'Russell',nationality:'British'},Constructor:{name:'Mercedes'},points:'0',laps:'78',Time:{time:'+43.353'},status:'Finished'},
      {position:'14',Driver:{driverId:'hulkenberg',familyName:'Hülkenberg',nationality:'German'},Constructor:{name:'Audi'},points:'0',laps:'78',Time:{time:'+44.102'},status:'Finished'},
      {position:'15',Driver:{driverId:'colapinto',familyName:'Colapinto',nationality:'Argentine'},Constructor:{name:'Alpine F1 Team'},points:'0',laps:'78',Time:{time:'+48.964'},status:'Finished'},
      {position:'16',Driver:{driverId:'sainz',familyName:'Sainz',nationality:'Spanish'},Constructor:{name:'Williams'},points:'0',laps:'70',status:'Retired'},
      {position:'R',Driver:{driverId:'leclerc',familyName:'Leclerc',nationality:'Monegasque'},Constructor:{name:'Ferrari'},points:'0',laps:'64',status:'Retired'},
      {position:'R',Driver:{driverId:'stroll',familyName:'Stroll',nationality:'Canadian'},Constructor:{name:'Aston Martin'},points:'0',laps:'56',status:'Retired'},
      {position:'R',Driver:{driverId:'norris',familyName:'Norris',nationality:'British'},Constructor:{name:'McLaren'},points:'0',laps:'43',status:'Retired'},
      {position:'R',Driver:{driverId:'bearman',familyName:'Bearman',nationality:'British'},Constructor:{name:'Haas F1 Team'},points:'0',laps:'27',status:'Retired'},
      {position:'R',Driver:{driverId:'bottas',familyName:'Bottas',nationality:'Finnish'},Constructor:{name:'Cadillac F1 Team'},points:'0',laps:'15',status:'Retired'},
...
const HARDCODED_DRIVER_STANDINGS=[
  ...
  {position:'18',points:'1',Driver:{driverId:'perez',familyName:'Pérez',givenName:'Sergio',nationality:'Mexican'},Constructors:[{name:'Cadillac F1 Team'}]},
  ...
  {position:'20',points:'0',Driver:{driverId:'alonso',familyName:'Alonso',givenName:'Fernando',nationality:'Spanish'},Constructors:[{name:'Aston Martin'}]},
...
const HARDCODED_CONSTRUCTOR_STANDINGS=[
  ...
  {position:'10',points:'1',Constructor:{name:'Cadillac F1 Team',nationality:'American'}},
