...
const HARDCODED_RACES={
  ...
  5:{round:'5',raceName:'Canadian Grand Prix',date:'2026-05-24',Circuit:{circuitName:'Circuit Gilles Villeneuve',Location:{country:'🇨🇦'}},
    Results:[
      ...
      {position:'2',Driver:{driverId:'hamilton',familyName:'Hamilton',nationality:'British'},Constructor:{name:'Ferrari'},points:'18',laps:'68',Time:{time:'+10.768'},status:'Finished',FastestLap:{rank:'3',lap:'61',Time:{time:'1:14.573'}}},
      {position:'3',Driver:{driverId:'max_verstappen',familyName:'Verstappen',nationality:'Dutch'},Constructor:{name:'Red Bull'},points:'15',laps:'68',Time:{time:'+11.276'},status:'Finished',FastestLap:{rank:'2',lap:'68',Time:{time:'1:14.398'}}},
      {position:'4',Driver:{driverId:'leclerc',familyName:'Leclerc',nationality:'Monegasque'},Constructor:{name:'Ferrari'},points:'12',laps:'68',Time:{time:'+44.151'},status:'Finished',FastestLap:{rank:'5',lap:'37',Time:{time:'1:15.297'}}},
      {position:'5',Driver:{driverId:'hadjar',familyName:'Hadjar',nationality:'French'},Constructor:{name:'Red Bull'},points:'10',laps:'67',Time:{time:'+5.033'},status:'Lapped',FastestLap:{rank:'4',lap:'67',Time:{time:'1:14.578'}}},
      {position:'6',Driver:{driverId:'colapinto',familyName:'Colapinto',nationality:'Argentine'},Constructor:{name:'Alpine F1 Team'},points:'8',laps:'67',Time:{time:'+19.510'},status:'Lapped',FastestLap:{rank:'8',lap:'67',Time:{time:'1:15.462'}}},
      {position:'7',Driver:{driverId:'lawson',familyName:'Lawson',nationality:'New Zealander'},Constructor:{name:'Racing Bulls'},points:'6',laps:'67',Time:{time:'+34.235'},status:'Lapped',FastestLap:{rank:'10',lap:'59',Time:{time:'1:15.604'}}},
      {position:'8',Driver:{driverId:'gasly',familyName:'Gasly',nationality:'French'},Constructor:{name:'Alpine F1 Team'},points:'4',laps:'67',Time:{time:'+34.572'},status:'Lapped',FastestLap:{rank:'6',lap:'67',Time:{time:'1:15.390'}}},
      {position:'9',Driver:{driverId:'sainz',familyName:'Sainz',nationality:'Spanish'},Constructor:{name:'Williams'},points:'2',laps:'67',Time:{time:'+58.014'},status:'Lapped',FastestLap:{rank:'12',lap:'65',Time:{time:'1:15.852'}}},
      {position:'10',Driver:{driverId:'bearman',familyName:'Bearman',nationality:'British'},Constructor:{name:'Haas F1 Team'},points:'1',laps:'67',Time:{time:'+59.049'},status:'Lapped',FastestLap:{rank:'13',lap:'64',Time:{time:'1:16.002'}}},
      {position:'11',Driver:{driverId:'piastri',familyName:'Piastri',nationality:'Australian'},Constructor:{name:'McLaren'},points:'0',laps:'66',Time:{time:'+12.699'},status:'Lapped',FastestLap:{rank:'7',lap:'61',Time:{time:'1:15.456'}}},
      {position:'12',Driver:{driverId:'hulkenberg',familyName:'Hülkenberg',nationality:'German'},Constructor:{name:'Audi'},points:'0',laps:'66',Time:{time:'+14.182'},status:'Lapped',FastestLap:{rank:'15',lap:'57',Time:{time:'1:16.275'}}},
      {position:'13',Driver:{driverId:'bortoleto',familyName:'Bortoleto',nationality:'Brazilian'},Constructor:{name:'Audi'},points:'0',laps:'66',Time:{time:'+21.156'},status:'Lapped',FastestLap:{rank:'14',lap:'50',Time:{time:'1:16.221'}}},
      {position:'14',Driver:{driverId:'ocon',familyName:'Ocon',nationality:'French'},Constructor:{name:'Haas F1 Team'},points:'0',laps:'66',Time:{time:'+1:08.635'},status:'Lapped',FastestLap:{rank:'16',lap:'64',Time:{time:'1:16.577'}}},
      {position:'15',Driver:{driverId:'stroll',familyName:'Stroll',nationality:'Canadian'},Constructor:{name:'Aston Martin'},points:'0',laps:'64',Time:{time:'+18.397'},status:'Lapped',FastestLap:{rank:'20',lap:'39',Time:{time:'1:18.721'}}},
      {position:'16',Driver:{driverId:'bottas',familyName:'Bottas',nationality:'Finnish'},Constructor:{name:'Cadillac F1 Team'},points:'0',laps:'64',Time:{time:'+53.390'},status:'Lapped',FastestLap:{rank:'19',lap:'59',Time:{time:'1:17.725'}}},
      {position:'R',Driver:{driverId:'perez',familyName:'Pérez',nationality:'Mexican'},Constructor:{name:'Cadillac F1 Team'},points:'0',laps:'39',status:'Retired',FastestLap:{rank:'17',lap:'37',Time:{time:'1:16.915'}}},
      {position:'R',Driver:{driverId:'norris',familyName:'Norris',nationality:'British'},Constructor:{name:'McLaren'},points:'0',laps:'38',status:'Retired',FastestLap:{rank:'11',lap:'36',Time:{time:'1:15.845'}}},
      {position:'R',Driver:{driverId:'russell',familyName:'Russell',nationality:'British'},Constructor:{name:'Mercedes'},points:'0',laps:'29',status:'Retired',FastestLap:{rank:'9',lap:'16',Time:{time:'1:15.477'}}},
      {position:'R',Driver:{driverId:'alonso',familyName:'Alonso',nationality:'Spanish'},Constructor:{name:'Aston Martin'},points:'0',laps:'23',status:'Retired',FastestLap:{rank:'21',lap:'10',Time:{time:'1:19.635'}}},
      {position:'R',Driver:{driverId:'albon',familyName:'Albon',nationality:'Thai'},Constructor:{name:'Williams'},points:'0',laps:'11',status:'Retired',FastestLap:{rank:'18',lap:'11',Time:{time:'1:17.221'}}},
      {position:'W',Driver:{driverId:'arvid_lindblad',familyName:'Lindblad',nationality:'British'},Constructor:{name:'Racing Bulls'},points:'0',laps:'0',status:'Did not start'},
    ]}
};

// Hardcoded verified championship standings (after Miami, R4) — official totals
const HARDCODED_DRIVER_STANDINGS=[
  {position:'1',points:'131',Driver:{driverId:'antonelli',familyName:'Antonelli',givenName:'Andrea Kimi',nationality:'Italian'},Constructors:[{name:'Mercedes'}]},
  ...
  {position:'7',points:'43',Driver:{driverId:'max_verstappen',familyName:'Verstappen',givenName:'Max',nationality:'Dutch'},Constructors:[{name:'Red Bull'}]},
  {position:'8',points:'20',Driver:{driverId:'gasly',familyName:'Gasly',givenName:'Pierre',nationality:'French'},Constructors:[{name:'Alpine F1 Team'}]},
  ...
  {position:'11',points:'15',Driver:{driverId:'colapinto',familyName:'Colapinto',givenName:'Franco',nationality:'Argentine'},Constructors:[{name:'Alpine F1 Team'}]},
  ...
  {position:'14',points:'5',Driver:{driverId:'arvid_lindblad',familyName:'Lindblad',givenName:'Arvid',nationality:'British'},Constructors:[{name:'Racing Bulls'}]},
  ...
  {position:'18',points:'0',Driver:{driverId:'hulkenberg',familyName:'Hülkenberg',givenName:'Nico',nationality:'German'},Constructors:[{name:'Audi'}]},
  {position:'19',points:'0',Driver:{driverId:'bottas',familyName:'Bottas',givenName:'Valtteri',nationality:'Finnish'},Constructors:[{name:'Cadillac F1 Team'}]},
  {position:'20',points:'0',Driver:{driverId:'perez',familyName:'Pérez',givenName:'Sergio',nationality:'Mexican'},Constructors:[{name:'Cadillac F1 Team'}]},
...
const HARDCODED_CONSTRUCTOR_STANDINGS=[
  ...
  {position:'5',points:'35',Constructor:{name:'Alpine F1 Team',nationality:'French'}},
  ...
  {position:'10',points:'0',Constructor:{name:'Cadillac F1 Team',nationality:'American'}},
