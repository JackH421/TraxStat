...
const HARDCODED_RACES={
  ...
  10:{round:'10',raceName:'Belgian Grand Prix',date:'2026-07-19',Circuit:{circuitName:'Circuit de Spa-Francorchamps',Location:{country:'🇧🇪'}},
    Results:[
      {position:'1',Driver:{driverId:'antonelli',familyName:'Antonelli',nationality:'Italian'},Constructor:{name:'Mercedes'},points:'25',laps:'44',Time:{time:'1:24:42.479'},status:'Finished',FastestLap:{rank:'2',lap:'41',Time:{time:'1:49.098'}}},
      {position:'2',Driver:{driverId:'leclerc',familyName:'Leclerc',nationality:'Monegasque'},Constructor:{name:'Ferrari'},points:'18',laps:'44',Time:{time:'+1.952'},status:'Finished',FastestLap:{rank:'4',lap:'23',Time:{time:'1:49.333'}}},
      {position:'3',Driver:{driverId:'max_verstappen',familyName:'Verstappen',nationality:'Dutch'},Constructor:{name:'Red Bull'},points:'15',laps:'44',Time:{time:'+11.586'},status:'Finished',FastestLap:{rank:'7',lap:'23',Time:{time:'1:49.618'}}},
      {position:'4',Driver:{driverId:'hamilton',familyName:'Hamilton',nationality:'British'},Constructor:{name:'Ferrari'},points:'12',laps:'44',Time:{time:'+17.245'},status:'Finished',FastestLap:{rank:'5',lap:'33',Time:{time:'1:49.454'}}},
      {position:'5',Driver:{driverId:'piastri',familyName:'Piastri',nationality:'Australian'},Constructor:{name:'McLaren'},points:'10',laps:'44',Time:{time:'+18.988'},status:'Finished',FastestLap:{rank:'6',lap:'23',Time:{time:'1:49.562'}}},
      {position:'6',Driver:{driverId:'hadjar',familyName:'Hadjar',nationality:'French'},Constructor:{name:'Red Bull'},points:'8',laps:'44',Time:{time:'+23.307'},status:'Finished',FastestLap:{rank:'3',lap:'44',Time:{time:'1:49.298'}}},
      {position:'7',Driver:{driverId:'norris',familyName:'Norris',nationality:'British'},Constructor:{name:'McLaren'},points:'6',laps:'44',Time:{time:'+24.014'},status:'Finished',FastestLap:{rank:'1',lap:'44',Time:{time:'1:48.890'}}},
      {position:'8',Driver:{driverId:'bortoleto',familyName:'Bortoleto',nationality:'Brazilian'},Constructor:{name:'Audi'},points:'4',laps:'44',Time:{time:'+49.140'},status:'Finished',FastestLap:{rank:'8',lap:'22',Time:{time:'1:50.334'}}},
      {position:'9',Driver:{driverId:'arvid_lindblad',familyName:'Lindblad',nationality:'British'},Constructor:{name:'Racing Bulls'},points:'2',laps:'44',Time:{time:'+50.406'},status:'Finished',FastestLap:{rank:'10',lap:'23',Time:{time:'1:50.536'}}},
      {position:'10',Driver:{driverId:'colapinto',familyName:'Colapinto',nationality:'Argentine'},Constructor:{name:'Alpine F1 Team'},points:'1',laps:'44',Time:{time:'+1:16.037'},status:'Finished',FastestLap:{rank:'14',lap:'42',Time:{time:'1:51.162'}}},
      {position:'11',Driver:{driverId:'gasly',familyName:'Gasly',nationality:'French'},Constructor:{name:'Alpine F1 Team'},points:'0',laps:'44',Time:{time:'+1:16.991'},status:'Finished',FastestLap:{rank:'12',lap:'39',Time:{time:'1:51.101'}}},
      {position:'12',Driver:{driverId:'lawson',familyName:'Lawson',nationality:'New Zealander'},Constructor:{name:'Racing Bulls'},points:'0',laps:'44',Time:{time:'+1:17.523'},status:'Finished',FastestLap:{rank:'11',lap:'44',Time:{time:'1:51.075'}}},
      {position:'13',Driver:{driverId:'hulkenberg',familyName:'Hülkenberg',nationality:'German'},Constructor:{name:'Audi'},points:'0',laps:'44',Time:{time:'+1:18.348'},status:'Finished',FastestLap:{rank:'9',lap:'41',Time:{time:'1:50.503'}}},
      {position:'14',Driver:{driverId:'bearman',familyName:'Bearman',nationality:'British'},Constructor:{name:'Haas F1 Team'},points:'0',laps:'44',Time:{time:'+1:34.465'},status:'Finished',FastestLap:{rank:'13',lap:'22',Time:{time:'1:51.109'}}},
      {position:'15',Driver:{driverId:'albon',familyName:'Albon',nationality:'Thai'},Constructor:{name:'Williams'},points:'0',laps:'44',Time:{time:'+1:44.684'},status:'Finished',FastestLap:{rank:'16',lap:'21',Time:{time:'1:51.894'}}},
      {position:'16',Driver:{driverId:'sainz',familyName:'Sainz',nationality:'Spanish'},Constructor:{name:'Williams'},points:'0',laps:'44',Time:{time:'+1:45.856'},status:'Finished',FastestLap:{rank:'15',lap:'24',Time:{time:'1:51.363'}}},
      {position:'17',Driver:{driverId:'ocon',familyName:'Ocon',nationality:'French'},Constructor:{name:'Haas F1 Team'},points:'0',laps:'44',Time:{time:'+1:50.925'},status:'Finished',FastestLap:{rank:'17',lap:'44',Time:{time:'1:51.900'}}},
      {position:'18',Driver:{driverId:'bottas',familyName:'Bottas',nationality:'Finnish'},Constructor:{name:'Cadillac F1 Team'},points:'0',laps:'43',Time:{time:'+1:00.979'},status:'Lapped',FastestLap:{rank:'18',lap:'35',Time:{time:'1:52.011'}}},
      {position:'19',Driver:{driverId:'alonso',familyName:'Alonso',nationality:'Spanish'},Constructor:{name:'Aston Martin'},points:'0',laps:'42',Time:{time:'+20.848'},status:'Lapped',FastestLap:{rank:'19',lap:'34',Time:{time:'1:52.948'}}},
      {position:'R',Driver:{driverId:'stroll',familyName:'Stroll',nationality:'Canadian'},Constructor:{name:'Aston Martin'},points:'0',laps:'25',status:'Retired',FastestLap:{rank:'21',lap:'21',Time:{time:'1:53.980'}}},
      {position:'R',Driver:{driverId:'perez',familyName:'Pérez',nationality:'Mexican'},Constructor:{name:'Cadillac F1 Team'},points:'0',laps:'13',status:'Retired',FastestLap:{rank:'20',lap:'10',Time:{time:'1:53.520'}}},
      {position:'R',Driver:{driverId:'russell',familyName:'Russell',nationality:'British'},Constructor:{name:'Mercedes'},points:'0',laps:'0',status:'Retired'},
    ]}
};
...
const HARDCODED_DRIVER_STANDINGS=[
  {position:'1',points:'204',Driver:{driverId:'antonelli',familyName:'Antonelli',givenName:'Andrea Kimi',nationality:'Italian'},Constructors:[{name:'Mercedes'}]},
  {position:'2',points:'159',Driver:{driverId:'hamilton',familyName:'Hamilton',givenName:'Lewis',nationality:'British'},Constructors:[{name:'Ferrari'}]},
  {position:'3',points:'154',Driver:{driverId:'russell',familyName:'Russell',givenName:'George',nationality:'British'},Constructors:[{name:'Mercedes'}]},
  {position:'4',points:'126',Driver:{driverId:'leclerc',familyName:'Leclerc',givenName:'Charles',nationality:'Monegasque'},Constructors:[{name:'Ferrari'}]},
  {position:'5',points:'103',Driver:{driverId:'norris',familyName:'Norris',givenName:'Lando',nationality:'British'},Constructors:[{name:'McLaren'}]},
  {position:'6',points:'92',Driver:{driverId:'piastri',familyName:'Piastri',givenName:'Oscar',nationality:'Australian'},Constructors:[{name:'McLaren'}]},
  {position:'7',points:'91',Driver:{driverId:'max_verstappen',familyName:'Verstappen',givenName:'Max',nationality:'Dutch'},Constructors:[{name:'Red Bull'}]},
  {position:'8',points:'60',Driver:{driverId:'hadjar',familyName:'Hadjar',givenName:'Isack',nationality:'French'},Constructors:[{name:'Red Bull'}]},
  {position:'9',points:'42',Driver:{driverId:'gasly',familyName:'Gasly',givenName:'Pierre',nationality:'French'},Constructors:[{name:'Alpine F1 Team'}]},
  {position:'10',points:'39',Driver:{driverId:'lawson',familyName:'Lawson',givenName:'Liam',nationality:'New Zealander'},Constructors:[{name:'Racing Bulls'}]},
  {position:'11',points:'22',Driver:{driverId:'arvid_lindblad',familyName:'Lindblad',givenName:'Arvid',nationality:'British'},Constructors:[{name:'Racing Bulls'}]},
...
const HARDCODED_CONSTRUCTOR_STANDINGS=[
  {position:'1',points:'358',Constructor:{name:'Mercedes',nationality:'German'}},
  {position:'2',points:'285',Constructor:{name:'Ferrari',nationality:'Italian'}},
  {position:'3',points:'195',Constructor:{name:'McLaren',nationality:'British'}},
  {position:'4',points:'151',Constructor:{name:'Red Bull',nationality:'Austrian'}},
  {position:'5',points:'61',Constructor:{name:'Alpine F1 Team',nationality:'French'}},
  {position:'6',points:'61',Constructor:{name:'Racing Bulls',nationality:'Italian'}},
  ...
  {position:'9',points:'10',Constructor:{name:'Audi',nationality:'German'}},
