...
const HARDCODED_RACES={
  ...
  11:{round:'11',raceName:'Hungarian Grand Prix',date:'2026-07-26',Circuit:{circuitName:'Hungaroring',Location:{country:'🇭🇺'}},
    Results:[
      {position:'1',Driver:{driverId:'norris',familyName:'Norris',nationality:'British'},Constructor:{name:'McLaren'},points:'25',laps:'70',Time:{time:'1:39:56.180'},status:'Finished',FastestLap:{rank:'4',lap:'64',Time:{time:'1:22.491'}}},
      {position:'2',Driver:{driverId:'max_verstappen',familyName:'Verstappen',nationality:'Dutch'},Constructor:{name:'Red Bull'},points:'18',laps:'70',Time:{time:'+15.080'},status:'Finished',FastestLap:{rank:'8',lap:'66',Time:{time:'1:23.433'}}},
      {position:'3',Driver:{driverId:'antonelli',familyName:'Antonelli',nationality:'Italian'},Constructor:{name:'Mercedes'},points:'15',laps:'70',Time:{time:'+18.728'},status:'Finished',FastestLap:{rank:'3',lap:'58',Time:{time:'1:22.415'}}},
      {position:'4',Driver:{driverId:'leclerc',familyName:'Leclerc',nationality:'Monegasque'},Constructor:{name:'Ferrari'},points:'12',laps:'70',Time:{time:'+23.840'},status:'Finished',FastestLap:{rank:'1',lap:'58',Time:{time:'1:22.000'}}},
      {position:'5',Driver:{driverId:'hamilton',familyName:'Hamilton',nationality:'British'},Constructor:{name:'Ferrari'},points:'10',laps:'70',Time:{time:'+24.540'},status:'Finished',FastestLap:{rank:'2',lap:'59',Time:{time:'1:22.300'}}},
      {position:'6',Driver:{driverId:'hadjar',familyName:'Hadjar',nationality:'French'},Constructor:{name:'Red Bull'},points:'8',laps:'70',Time:{time:'+55.488'},status:'Finished',FastestLap:{rank:'7',lap:'45',Time:{time:'1:23.218'}}},
      {position:'7',Driver:{driverId:'russell',familyName:'Russell',nationality:'British'},Constructor:{name:'Mercedes'},points:'6',laps:'70',Time:{time:'+57.503'},status:'Finished',FastestLap:{rank:'5',lap:'58',Time:{time:'1:22.589'}}},
      {position:'8',Driver:{driverId:'lawson',familyName:'Lawson',nationality:'New Zealander'},Constructor:{name:'Racing Bulls'},points:'4',laps:'69',Time:{time:'+28.033'},status:'Lapped',FastestLap:{rank:'11',lap:'64',Time:{time:'1:23.900'}}},
      {position:'9',Driver:{driverId:'hulkenberg',familyName:'Hülkenberg',nationality:'German'},Constructor:{name:'Audi'},points:'2',laps:'69',Time:{time:'+30.382'},status:'Lapped',FastestLap:{rank:'12',lap:'67',Time:{time:'1:23.964'}}},
      {position:'10',Driver:{driverId:'arvid_lindblad',familyName:'Lindblad',nationality:'British'},Constructor:{name:'Racing Bulls'},points:'1',laps:'69',Time:{time:'+51.050'},status:'Lapped',FastestLap:{rank:'20',lap:'47',Time:{time:'1:25.931'}}},
      {position:'11',Driver:{driverId:'bortoleto',familyName:'Bortoleto',nationality:'Brazilian'},Constructor:{name:'Audi'},points:'0',laps:'69',Time:{time:'+52.028'},status:'Lapped',FastestLap:{rank:'15',lap:'33',Time:{time:'1:24.783'}}},
      {position:'12',Driver:{driverId:'gasly',familyName:'Gasly',nationality:'French'},Constructor:{name:'Alpine F1 Team'},points:'0',laps:'69',Time:{time:'+53.429'},status:'Lapped',FastestLap:{rank:'6',lap:'57',Time:{time:'1:22.871'}}},
      {position:'13',Driver:{driverId:'stroll',familyName:'Stroll',nationality:'Canadian'},Constructor:{name:'Aston Martin'},points:'0',laps:'69',Time:{time:'+1:03.828'},status:'Lapped',FastestLap:{rank:'14',lap:'57',Time:{time:'1:24.718'}}},
      {position:'14',Driver:{driverId:'alonso',familyName:'Alonso',nationality:'Spanish'},Constructor:{name:'Aston Martin'},points:'0',laps:'69',Time:{time:'+1:06.052'},status:'Lapped',FastestLap:{rank:'9',lap:'57',Time:{time:'1:23.679'}}},
      {position:'15',Driver:{driverId:'colapinto',familyName:'Colapinto',nationality:'Argentine'},Constructor:{name:'Alpine F1 Team'},points:'0',laps:'68',Time:{time:'+3.876'},status:'Lapped',FastestLap:{rank:'13',lap:'40',Time:{time:'1:24.624'}}},
      {position:'16',Driver:{driverId:'ocon',familyName:'Ocon',nationality:'French'},Constructor:{name:'Haas F1 Team'},points:'0',laps:'68',Time:{time:'+12.859'},status:'Lapped',FastestLap:{rank:'19',lap:'62',Time:{time:'1:25.889'}}},
      {position:'17',Driver:{driverId:'albon',familyName:'Albon',nationality:'Thai'},Constructor:{name:'Williams'},points:'0',laps:'68',Time:{time:'+52.729'},status:'Lapped',FastestLap:{rank:'17',lap:'57',Time:{time:'1:25.403'}}},
      {position:'18',Driver:{driverId:'sainz',familyName:'Sainz',nationality:'Spanish'},Constructor:{name:'Williams'},points:'0',laps:'68',Time:{time:'+52.973'},status:'Lapped',FastestLap:{rank:'16',lap:'56',Time:{time:'1:24.864'}}},
      {position:'19',Driver:{driverId:'bearman',familyName:'Bearman',nationality:'British'},Constructor:{name:'Haas F1 Team'},points:'0',laps:'68',Time:{time:'+57.198'},status:'Lapped',FastestLap:{rank:'18',lap:'24',Time:{time:'1:25.884'}}},
      {position:'R',Driver:{driverId:'piastri',familyName:'Piastri',nationality:'Australian'},Constructor:{name:'McLaren'},points:'0',laps:'55',status:'Retired',FastestLap:{rank:'10',lap:'35',Time:{time:'1:23.896'}}},
      {position:'R',Driver:{driverId:'perez',familyName:'Pérez',nationality:'Mexican'},Constructor:{name:'Cadillac F1 Team'},points:'0',laps:'48',status:'Retired',FastestLap:{rank:'21',lap:'23',Time:{time:'1:26.342'}}},
      {position:'R',Driver:{driverId:'bottas',familyName:'Bottas',nationality:'Finnish'},Constructor:{name:'Cadillac F1 Team'},points:'0',laps:'13',status:'Retired',FastestLap:{rank:'22',lap:'4',Time:{time:'1:27.959'}}},
    ]}
};
...
const HARDCODED_DRIVER_STANDINGS=[
  {position:'1',points:'219',Driver:{driverId:'antonelli',familyName:'Antonelli',givenName:'Andrea Kimi',nationality:'Italian'},Constructors:[{name:'Mercedes'}]},
  {position:'2',points:'169',Driver:{driverId:'hamilton',familyName:'Hamilton',givenName:'Lewis',nationality:'British'},Constructors:[{name:'Ferrari'}]},
  {position:'3',points:'160',Driver:{driverId:'russell',familyName:'Russell',givenName:'George',nationality:'British'},Constructors:[{name:'Mercedes'}]},
  {position:'4',points:'138',Driver:{driverId:'leclerc',familyName:'Leclerc',givenName:'Charles',nationality:'Monegasque'},Constructors:[{name:'Ferrari'}]},
  {position:'5',points:'128',Driver:{driverId:'norris',familyName:'Norris',givenName:'Lando',nationality:'British'},Constructors:[{name:'McLaren'}]},
  {position:'6',points:'109',Driver:{driverId:'max_verstappen',familyName:'Verstappen',givenName:'Max',nationality:'Dutch'},Constructors:[{name:'Red Bull'}]},
  {position:'7',points:'92',Driver:{driverId:'piastri',familyName:'Piastri',givenName:'Oscar',nationality:'Australian'},Constructors:[{name:'McLaren'}]},
  {position:'8',points:'68',Driver:{driverId:'hadjar',familyName:'Hadjar',givenName:'Isack',nationality:'French'},Constructors:[{name:'Red Bull'}]},
  {position:'9',points:'43',Driver:{driverId:'lawson',familyName:'Lawson',givenName:'Liam',nationality:'New Zealander'},Constructors:[{name:'Racing Bulls'}]},
  {position:'10',points:'42',Driver:{driverId:'gasly',familyName:'Gasly',givenName:'Pierre',nationality:'French'},Constructors:[{name:'Alpine F1 Team'}]},
  {position:'11',points:'23',Driver:{driverId:'arvid_lindblad',familyName:'Lindblad',givenName:'Arvid',nationality:'British'},Constructors:[{name:'Racing Bulls'}]},
  {position:'12',points:'19',Driver:{driverId:'colapinto',familyName:'Colapinto',givenName:'Franco',nationality:'Argentine'},Constructors:[{name:'Alpine F1 Team'}]},
  {position:'13',points:'18',Driver:{driverId:'bearman',familyName:'Bearman',givenName:'Oliver',nationality:'British'},Constructors:[{name:'Haas F1 Team'}]},
  {position:'14',points:'10',Driver:{driverId:'bortoleto',familyName:'Bortoleto',givenName:'Gabriel',nationality:'Brazilian'},Constructors:[{name:'Audi'}]},
  {position:'15',points:'6',Driver:{driverId:'sainz',familyName:'Sainz',givenName:'Carlos',nationality:'Spanish'},Constructors:[{name:'Williams'}]},
  {position:'16',points:'5',Driver:{driverId:'albon',familyName:'Albon',givenName:'Alexander',nationality:'Thai'},Constructors:[{name:'Williams'}]},
  {position:'17',points:'3',Driver:{driverId:'ocon',familyName:'Ocon',givenName:'Esteban',nationality:'French'},Constructors:[{name:'Haas F1 Team'}]},
  {position:'18',points:'2',Driver:{driverId:'hulkenberg',familyName:'Hülkenberg',givenName:'Nico',nationality:'German'},Constructors:[{name:'Audi'}]},
  {position:'19',points:'1',Driver:{driverId:'alonso',familyName:'Alonso',givenName:'Fernando',nationality:'Spanish'},Constructors:[{name:'Aston Martin'}]},
  {position:'20',points:'0',Driver:{driverId:'stroll',familyName:'Stroll',givenName:'Lance',nationality:'Canadian'},Constructors:[{name:'Aston Martin'}]},
  {position:'21',points:'0',Driver:{driverId:'bottas',familyName:'Bottas',givenName:'Valtteri',nationality:'Finnish'},Constructors:[{name:'Cadillac F1 Team'}]},
  {position:'22',points:'0',Driver:{driverId:'perez',familyName:'Pérez',givenName:'Sergio',nationality:'Mexican'},Constructors:[{name:'Cadillac F1 Team'}]},
];

const HARDCODED_CONSTRUCTOR_STANDINGS=[
  {position:'1',points:'379',Constructor:{name:'Mercedes',nationality:'German'}},
  {position:'2',points:'307',Constructor:{name:'Ferrari',nationality:'Italian'}},
  {position:'3',points:'220',Constructor:{name:'McLaren',nationality:'British'}},
  {position:'4',points:'177',Constructor:{name:'Red Bull',nationality:'Austrian'}},
  {position:'5',points:'66',Constructor:{name:'Racing Bulls',nationality:'Italian'}},
  {position:'6',points:'61',Constructor:{name:'Alpine F1 Team',nationality:'French'}},
  {position:'7',points:'21',Constructor:{name:'Haas F1 Team',nationality:'American'}},
  {position:'8',points:'12',Constructor:{name:'Audi',nationality:'German'}},
  {position:'9',points:'11',Constructor:{name:'Williams',nationality:'British'}},
