...
const HARDCODED_RACES={
  ...
  9:{round:'9',raceName:'British Grand Prix',date:'2026-07-05',Circuit:{circuitName:'Silverstone Circuit',Location:{country:'🇬🇧'}},
    Results:[
      ...
      {position:'12',Driver:{driverId:'bearman',familyName:'Bearman',nationality:'British'},Constructor:{name:'Haas F1 Team'},points:'0',laps:'52',Time:{time:'+5.245'},status:'Finished',FastestLap:{rank:'17',lap:'31',Time:{time:'1:34.455'}}},
      {position:'13',Driver:{driverId:'ocon',familyName:'Ocon',nationality:'French'},Constructor:{name:'Haas F1 Team'},points:'0',laps:'52',Time:{time:'+5.512'},status:'Finished',FastestLap:{rank:'18',lap:'43',Time:{time:'1:34.792'}}},
      {position:'14',Driver:{driverId:'perez',familyName:'Pérez',nationality:'Mexican'},Constructor:{name:'Cadillac F1 Team'},points:'0',laps:'52',Time:{time:'+7.403'},status:'Finished',FastestLap:{rank:'19',lap:'44',Time:{time:'1:35.520'}}},
      {position:'15',Driver:{driverId:'antonelli',familyName:'Antonelli',nationality:'Italian'},Constructor:{name:'Mercedes'},points:'0',laps:'52',Time:{time:'+8.005'},status:'Finished',FastestLap:{rank:'1',lap:'37',Time:{time:'1:31.777'}}},
      {position:'16',Driver:{driverId:'bottas',familyName:'Bottas',nationality:'Finnish'},Constructor:{name:'Cadillac F1 Team'},points:'0',laps:'52',Time:{time:'+8.162'},status:'Finished',FastestLap:{rank:'21',lap:'31',Time:{time:'1:35.893'}}},
      {position:'17',Driver:{driverId:'sainz',familyName:'Sainz',nationality:'Spanish'},Constructor:{name:'Williams'},points:'0',laps:'51',Time:{time:'+4.391'},status:'Lapped',FastestLap:{rank:'7',lap:'51',Time:{time:'1:32.734'}}},
