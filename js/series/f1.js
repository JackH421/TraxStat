...
const HARDCODED_RACES={
  ...
  6:{round:'6',raceName:'Monaco Grand Prix',date:'2026-06-07',Circuit:{circuitName:'Circuit de Monaco',Location:{country:'🇲🇨'}},
    Results:[
      ...
      {position:'2',Driver:{driverId:'hamilton',familyName:'Hamilton',nationality:'British'},Constructor:{name:'Ferrari'},points:'18',laps:'78',Time:{time:'+6.271'},status:'Finished',FastestLap:{rank:'2',lap:'74',Time:{time:'1:14.643'}}},
      {position:'3',Driver:{driverId:'hadjar',familyName:'Hadjar',nationality:'French'},Constructor:{name:'Red Bull'},points:'15',laps:'78',Time:{time:'+23.394'},status:'Finished',FastestLap:{rank:'4',lap:'77',Time:{time:'1:15.669'}}},
      {position:'4',Driver:{driverId:'piastri',familyName:'Piastri',nationality:'Australian'},Constructor:{name:'McLaren'},points:'12',laps:'78',Time:{time:'+24.261'},status:'Finished',FastestLap:{rank:'7',lap:'76',Time:{time:'1:15.816'}}},
      {position:'5',Driver:{driverId:'lawson',familyName:'Lawson',nationality:'New Zealander'},Constructor:{name:'Racing Bulls'},points:'10',laps:'78',Time:{time:'+26.553'},status:'Finished',FastestLap:{rank:'5',lap:'76',Time:{time:'1:15.754'}}},
      {position:'6',Driver:{driverId:'arvid_lindblad',familyName:'Lindblad',nationality:'British'},Constructor:{name:'Racing Bulls'},points:'8',laps:'78',Time:{time:'+29.010'},status:'Finished',FastestLap:{rank:'8',lap:'76',Time:{time:'1:15.908'}}},
      {position:'7',Driver:{driverId:'gasly',familyName:'Gasly',nationality:'French'},Constructor:{name:'Alpine F1 Team'},points:'6',laps:'78',Time:{time:'+30.369'},status:'Finished',FastestLap:{rank:'3',lap:'77',Time:{time:'1:15.497'}}},
      {position:'8',Driver:{driverId:'albon',familyName:'Albon',nationality:'Thai'},Constructor:{name:'Williams'},points:'4',laps:'78',Time:{time:'+33.413'},status:'Finished',FastestLap:{rank:'12',lap:'78',Time:{time:'1:16.393'}}},
      {position:'9',Driver:{driverId:'ocon',familyName:'Ocon',nationality:'French'},Constructor:{name:'Haas F1 Team'},points:'2',laps:'78',Time:{time:'+37.140'},status:'Finished',FastestLap:{rank:'15',lap:'77',Time:{time:'1:16.914'}}},
      {position:'10',Driver:{driverId:'alonso',familyName:'Alonso',nationality:'Spanish'},Constructor:{name:'Aston Martin'},points:'1',laps:'78',Time:{time:'+41.899'},status:'Finished',FastestLap:{rank:'16',lap:'77',Time:{time:'1:17.120'}}},
      {position:'11',Driver:{driverId:'bortoleto',familyName:'Bortoleto',nationality:'Brazilian'},Constructor:{name:'Audi'},points:'0',laps:'78',Time:{time:'+42.748'},status:'Finished',FastestLap:{rank:'13',lap:'46',Time:{time:'1:16.803'}}},
      {position:'12',Driver:{driverId:'russell',familyName:'Russell',nationality:'British'},Constructor:{name:'Mercedes'},points:'0',laps:'78',Time:{time:'+43.353'},status:'Finished',FastestLap:{rank:'6',lap:'56',Time:{time:'1:15.773'}}},
      {position:'13',Driver:{driverId:'hulkenberg',familyName:'Hülkenberg',nationality:'German'},Constructor:{name:'Audi'},points:'0',laps:'78',Time:{time:'+44.102'},status:'Finished',FastestLap:{rank:'11',lap:'15',Time:{time:'1:16.332'}}},
      {position:'14',Driver:{driverId:'colapinto',familyName:'Colapinto',nationality:'Argentine'},Constructor:{name:'Alpine F1 Team'},points:'0',laps:'78',Time:{time:'+48.964'},status:'Finished',FastestLap:{rank:'10',lap:'74',Time:{time:'1:16.316'}}},
      {position:'15',Driver:{driverId:'perez',familyName:'Pérez',nationality:'Mexican'},Constructor:{name:'Cadillac F1 Team'},points:'0',laps:'78',Time:{time:'+49.153'},status:'Finished',FastestLap:{rank:'14',lap:'78',Time:{time:'1:16.891'}}},
      {position:'16',Driver:{driverId:'sainz',familyName:'Sainz',nationality:'Spanish'},Constructor:{name:'Williams'},points:'0',laps:'70',status:'Retired',FastestLap:{rank:'18',lap:'51',Time:{time:'1:18.022'}}},
      {position:'R',Driver:{driverId:'leclerc',familyName:'Leclerc',nationality:'Monegasque'},Constructor:{name:'Ferrari'},points:'0',laps:'64',status:'Retired',FastestLap:{rank:'9',lap:'53',Time:{time:'1:15.964'}}},
      {position:'R',Driver:{driverId:'stroll',familyName:'Stroll',nationality:'Canadian'},Constructor:{name:'Aston Martin'},points:'0',laps:'56',status:'Retired',FastestLap:{rank:'20',lap:'36',Time:{time:'1:18.845'}}},
      {position:'R',Driver:{driverId:'norris',familyName:'Norris',nationality:'British'},Constructor:{name:'McLaren'},points:'0',laps:'43',status:'Retired',FastestLap:{rank:'17',lap:'34',Time:{time:'1:17.670'}}},
      {position:'R',Driver:{driverId:'bearman',familyName:'Bearman',nationality:'British'},Constructor:{name:'Haas F1 Team'},points:'0',laps:'27',status:'Retired',FastestLap:{rank:'19',lap:'22',Time:{time:'1:18.475'}}},
      {position:'R',Driver:{driverId:'bottas',familyName:'Bottas',nationality:'Finnish'},Constructor:{name:'Cadillac F1 Team'},points:'0',laps:'15',status:'Retired',FastestLap:{rank:'21',lap:'8',Time:{time:'1:20.494'}}},
      {position:'R',Driver:{driverId:'max_verstappen',familyName:'Verstappen',nationality:'Dutch'},Constructor:{name:'Red Bull'},points:'0',laps:'0',status:'Retired'},
    ]}
};
...
const HARDCODED_DRIVER_STANDINGS=[
  ...
  {position:'10',points:'26',Driver:{driverId:'gasly',familyName:'Gasly',givenName:'Pierre',nationality:'French'},Constructors:[{name:'Alpine F1 Team'}]},
  ...
  {position:'12',points:'15',Driver:{driverId:'colapinto',familyName:'Colapinto',givenName:'Franco',nationality:'Argentine'},Constructors:[{name:'Alpine F1 Team'}]},
...
const HARDCODED_CONSTRUCTOR_STANDINGS=[
  ...
  {position:'5',points:'41',Constructor:{name:'Alpine F1 Team',nationality:'French'}},
