const SEEDED_FASTEST_LAPS={
  ...
  7:{'hamilton':{time:'1:20.122',lap:'44',rank:'1'}},
};
...
const HARDCODED_RACES={
  ...
  6:{round:'6',raceName:'Monaco Grand Prix',date:'2026-06-07',Circuit:{circuitName:'Circuit de Monaco',Location:{country:'🇲🇨'}},
    Results:[
      ...
      {position:'3',Driver:{driverId:'gasly',familyName:'Gasly',nationality:'French'},Constructor:{name:'Alpine'},points:'15',laps:'78',Time:{time:'+23.394'},status:'Finished'},
      {position:'4',Driver:{driverId:'hadjar',familyName:'Hadjar',nationality:'French'},Constructor:{name:'Red Bull'},points:'12',laps:'78',Time:{time:'+24.261'},status:'Finished'},
      {position:'5',Driver:{driverId:'piastri',familyName:'Piastri',nationality:'Australian'},Constructor:{name:'McLaren'},points:'10',laps:'78',Time:{time:'+26.553'},status:'Finished'},
      {position:'6',Driver:{driverId:'lawson',familyName:'Lawson',nationality:'New Zealander'},Constructor:{name:'Racing Bulls'},points:'8',laps:'78',Time:{time:'+29.010'},status:'Finished'},
      {position:'7',Driver:{driverId:'lindblad',familyName:'Lindblad',nationality:'British'},Constructor:{name:'Racing Bulls'},points:'6',laps:'78',Time:{time:'+30.369'},status:'Finished'},
  ...
  7:{round:'7',raceName:'Barcelona Grand Prix',date:'2026-06-14',Circuit:{circuitName:'Circuit de Barcelona-Catalunya',Location:{country:'🇪🇸'}},
    Results:[
      ...
      {position:'7',Driver:{driverId:'gasly',familyName:'Gasly',nationality:'French'},Constructor:{name:'Alpine'},points:'6',laps:'65',Time:{time:'+55.789'},status:'Lapped',FastestLap:{rank:'13',lap:'43',Time:{time:'1:21.960'}}},
      ...
      {position:'10',Driver:{driverId:'colapinto',familyName:'Colapinto',nationality:'Argentine'},Constructor:{name:'Alpine'},points:'1',laps:'65',Time:{time:'+1:19.867'},status:'Lapped',FastestLap:{rank:'16',lap:'43',Time:{time:'1:22.449'}}},
      ...
      {position:'14',Driver:{driverId:'perez',familyName:'Perez',nationality:'Mexican'},Constructor:{name:'Cadillac'},points:'0',laps:'63',Time:{time:'+7.769'},status:'Lapped',FastestLap:{rank:'18',lap:'43',Time:{time:'1:22.820'}}},
      ...
      {position:'R',Driver:{driverId:'hulkenberg',familyName:'Hulkenberg',nationality:'German'},Constructor:{name:'Audi'},points:'0',laps:'29',status:'Retired',FastestLap:{rank:'19',lap:'2',Time:{time:'1:23.447'}}},
      {position:'R',Driver:{driverId:'bottas',familyName:'Bottas',nationality:'Finnish'},Constructor:{name:'Cadillac'},points:'0',laps:'15',status:'Retired',FastestLap:{rank:'21',lap:'3',Time:{time:'1:25.745'}}},
...
const HARDCODED_DRIVER_STANDINGS=[
  ...
  {position:'8',points:'41',Driver:{driverId:'gasly',familyName:'Gasly',givenName:'Pierre',nationality:'French'},Constructors:[{name:'Alpine'}]},
  ...
  {position:'12',points:'16',Driver:{driverId:'colapinto',familyName:'Colapinto',givenName:'Franco',nationality:'Argentine'},Constructors:[{name:'Alpine'}]},
...
const HARDCODED_CONSTRUCTOR_STANDINGS=[
  ...
  {position:'5',points:'57',Constructor:{name:'Alpine',nationality:'French'}},
...
const DRIVER_RACE_POINTS={
  'Antonelli':  [{round:1,race:'Australia',flag:'🇦🇺',pos:2,pts:18},{round:2,race:'China',flag:'🇨🇳',pos:1,pts:25},{round:3,race:'Japan',flag:'🇯🇵',pos:1,pts:25},{round:4,race:'Miami',flag:'🇺🇸',pos:1,pts:25},{round:5,race:'Canada',flag:'🇨🇦',pos:1,pts:25},{round:6,race:'Monaco',flag:'🇲🇨',pos:1,pts:25},{round:7,race:'Spain',flag:'🇪🇸',pos:0,pts:0}],
  'Russell':    [{round:1,race:'Australia',flag:'🇦🇺',pos:1,pts:25},{round:2,race:'China',flag:'🇨🇳',pos:2,pts:18},{round:3,race:'Japan',flag:'🇯🇵',pos:4,pts:12},{round:4,race:'Miami',flag:'🇺🇸',pos:4,pts:12},{round:5,race:'Canada',flag:'🇨🇦',pos:0,pts:0},{round:6,race:'Monaco',flag:'🇲🇨',pos:12,pts:0},{round:7,race:'Spain',flag:'🇪🇸',pos:2,pts:18}],
  'Leclerc':    [{round:1,race:'Australia',flag:'🇦🇺',pos:3,pts:15},{round:2,race:'China',flag:'🇨🇳',pos:4,pts:12},{round:3,race:'Japan',flag:'🇯🇵',pos:3,pts:15},{round:4,race:'Miami',flag:'🇺🇸',pos:8,pts:4},{round:5,race:'Canada',flag:'🇨🇦',pos:4,pts:12},{round:6,race:'Monaco',flag:'🇲🇨',pos:0,pts:0},{round:7,race:'Spain',flag:'🇪🇸',pos:0,pts:0}],
  'Norris':     [{round:1,race:'Australia',flag:'🇦🇺',pos:5,pts:10},{round:2,race:'China',flag:'🇨🇳',pos:0,pts:0},{round:3,race:'Japan',flag:'🇯🇵',pos:5,pts:10},{round:4,race:'Miami',flag:'🇺🇸',pos:2,pts:18},{round:5,race:'Canada',flag:'🇨🇦',pos:0,pts:0},{round:6,race:'Monaco',flag:'🇲🇨',pos:0,pts:0},{round:7,race:'Spain',flag:'🇪🇸',pos:3,pts:15}],
  'Hamilton':   [{round:1,race:'Australia',flag:'🇦🇺',pos:4,pts:12},{round:2,race:'China',flag:'🇨🇳',pos:3,pts:15},{round:3,race:'Japan',flag:'🇯🇵',pos:6,pts:8},{round:4,race:'Miami',flag:'🇺🇸',pos:6,pts:8},{round:5,race:'Canada',flag:'🇨🇦',pos:2,pts:18},{round:6,race:'Monaco',flag:'🇲🇨',pos:2,pts:18},{round:7,race:'Spain',flag:'🇪🇸',pos:1,pts:25}],
  'Piastri':    [{round:1,race:'Australia',flag:'🇦🇺',pos:0,pts:0},{round:2,race:'China',flag:'🇨🇳',pos:0,pts:0},{round:3,race:'Japan',flag:'🇯🇵',pos:2,pts:18},{round:4,race:'Miami',flag:'🇺🇸',pos:3,pts:15},{round:5,race:'Canada',flag:'🇨🇦',pos:11,pts:0},{round:6,race:'Monaco',flag:'🇲🇨',pos:5,pts:10},{round:7,race:'Spain',flag:'🇪🇸',pos:5,pts:10}],
  'Verstappen': [{round:1,race:'Australia',flag:'🇦🇺',pos:6,pts:8},{round:2,race:'China',flag:'🇨🇳',pos:0,pts:0},{round:3,race:'Japan',flag:'🇯🇵',pos:8,pts:4},{round:4,race:'Miami',flag:'🇺🇸',pos:5,pts:10},{round:5,race:'Canada',flag:'🇨🇦',pos:3,pts:15},{round:6,race:'Monaco',flag:'🇲🇨',pos:0,pts:0},{round:7,race:'Spain',flag:'🇪🇸',pos:4,pts:12}],
  'Bearman':    [{round:1,race:'Australia',flag:'🇦🇺',pos:7,pts:6},{round:2,race:'China',flag:'🇨🇳',pos:5,pts:10},{round:3,race:'Japan',flag:'🇯🇵',pos:0,pts:0},{round:4,race:'Miami',flag:'🇺🇸',pos:11,pts:0},{round:5,race:'Canada',flag:'🇨🇦',pos:10,pts:1},{round:6,race:'Monaco',flag:'🇲🇨',pos:0,pts:0},{round:7,race:'Spain',flag:'🇪🇸',pos:0,pts:0}],
  'Gasly':      [{round:1,race:'Australia',flag:'🇦🇺',pos:10,pts:1},{round:2,race:'China',flag:'🇨🇳',pos:6,pts:8},{round:3,race:'Japan',flag:'🇯🇵',pos:7,pts:6},{round:4,race:'Miami',flag:'🇺🇸',pos:0,pts:0},{round:5,race:'Canada',flag:'🇨🇦',pos:8,pts:4},{round:6,race:'Monaco',flag:'🇲🇨',pos:3,pts:15},{round:7,race:'Spain',flag:'🇪🇸',pos:7,pts:6}],
  'Lawson':     [{round:1,race:'Australia',flag:'🇦🇺',pos:13,pts:0},{round:2,race:'China',flag:'🇨🇳',pos:7,pts:6},{round:3,race:'Japan',flag:'🇯🇵',pos:9,pts:2},{round:4,race:'Miami',flag:'🇺🇸',pos:20,pts:0},{round:5,race:'Canada',flag:'🇨🇦',pos:7,pts:6},{round:6,race:'Monaco',flag:'🇲🇨',pos:6,pts:8},{round:7,race:'Spain',flag:'🇪🇸',pos:8,pts:4}],
  'Colapinto':  [{round:1,race:'Australia',flag:'🇦🇺',pos:14,pts:0},{round:2,race:'China',flag:'🇨🇳',pos:10,pts:1},{round:3,race:'Japan',flag:'🇯🇵',pos:16,pts:0},{round:4,race:'Miami',flag:'🇺🇸',pos:7,pts:6},{round:5,race:'Canada',flag:'🇨🇦',pos:6,pts:8},{round:6,race:'Monaco',flag:'🇲🇨',pos:14,pts:0},{round:7,race:'Spain',flag:'🇪🇸',pos:10,pts:1}],
  'Lindblad':   [{round:1,race:'Australia',flag:'🇦🇺',pos:8,pts:4},{round:2,race:'China',flag:'🇨🇳',pos:12,pts:0},{round:3,race:'Japan',flag:'🇯🇵',pos:14,pts:0},{round:4,race:'Miami',flag:'🇺🇸',pos:14,pts:0},{round:5,race:'Canada',flag:'🇨🇦',pos:0,pts:0},{round:6,race:'Monaco',flag:'🇲🇨',pos:7,pts:6},{round:7,race:'Spain',flag:'🇪🇸',pos:9,pts:2}],
  'Hadjar':     [{round:1,race:'Australia',flag:'🇦🇺',pos:0,pts:0},{round:2,race:'China',flag:'🇨🇳',pos:8,pts:4},{round:3,race:'Japan',flag:'🇯🇵',pos:12,pts:0},{round:4,race:'Miami',flag:'🇺🇸',pos:0,pts:0},{round:5,race:'Canada',flag:'🇨🇦',pos:5,pts:10},{round:6,race:'Monaco',flag:'🇲🇨',pos:4,pts:12},{round:7,race:'Spain',flag:'🇪🇸',pos:6,pts:8}],
  'Sainz':      [{round:1,race:'Australia',flag:'🇦🇺',pos:15,pts:0},{round:2,race:'China',flag:'🇨🇳',pos:9,pts:2},{round:3,race:'Japan',flag:'🇯🇵',pos:15,pts:0},{round:4,race:'Miami',flag:'🇺🇸',pos:9,pts:2},{round:5,race:'Canada',flag:'🇨🇦',pos:9,pts:2},{round:6,race:'Monaco',flag:'🇲🇨',pos:0,pts:0},{round:7,race:'Spain',flag:'🇪🇸',pos:12,pts:0}],
  'Bortoleto':  [{round:1,race:'Australia',flag:'🇦🇺',pos:9,pts:2},{round:2,race:'China',flag:'🇨🇳',pos:0,pts:0},{round:3,race:'Japan',flag:'🇯🇵',pos:13,pts:0},{round:4,race:'Miami',flag:'🇺🇸',pos:12,pts:0},{round:5,race:'Canada',flag:'🇨🇦',pos:13,pts:0},{round:6,race:'Monaco',flag:'🇲🇨',pos:11,pts:0},{round:7,race:'Spain',flag:'🇪🇸',pos:11,pts:0}],
  'Ocon':       [{round:1,race:'Australia',flag:'🇦🇺',pos:11,pts:0},{round:2,race:'China',flag:'🇨🇳',pos:14,pts:0},{round:3,race:'Japan',flag:'🇯🇵',pos:10,pts:1},{round:4,race:'Miami',flag:'🇺🇸',pos:13,pts:0},{round:5,race:'Canada',flag:'🇨🇦',pos:14,pts:0},{round:6,race:'Monaco',flag:'🇲🇨',pos:9,pts:2},{round:7,race:'Spain',flag:'🇪🇸',pos:13,pts:0}],
  'Albon':      [{round:1,race:'Australia',flag:'🇦🇺',pos:12,pts:0},{round:2,race:'China',flag:'🇨🇳',pos:0,pts:0},{round:3,race:'Japan',flag:'🇯🇵',pos:20,pts:0},{round:4,race:'Miami',flag:'🇺🇸',pos:10,pts:1},{round:5,race:'Canada',flag:'🇨🇦',pos:0,pts:0},{round:6,race:'Monaco',flag:'🇲🇨',pos:8,pts:4},{round:7,race:'Spain',flag:'🇪🇸',pos:0,pts:0}],
  'Alonso':     [{round:1,race:'Australia',flag:'🇦🇺',pos:0,pts:0},{round:2,race:'China',flag:'🇨🇳',pos:0,pts:0},{round:3,race:'Japan',flag:'🇯🇵',pos:18,pts:0},{round:4,race:'Miami',flag:'🇺🇸',pos:15,pts:0},{round:5,race:'Canada',flag:'🇨🇦',pos:0,pts:0},{round:6,race:'Monaco',flag:'🇲🇨',pos:10,pts:1},{round:7,race:'Spain',flag:'🇪🇸',pos:0,pts:0}],
};
...
async function renderDrivers(){
  ...
  try{
    ...
    const hdr=`<div class="section-title"><span>Drivers Championship · 2026 · After R7 Barcelona</span><span>Tap for breakdown</span></div>`;
...
async function renderConstructors(){
  ...
  try{
    ...
    if(!standings.length){content.innerHTML=`<div class="state-screen"><div class="state-icon">🏎</div><div class="state-title">No Data Yet</div></div>`;return;}
    const hdr=`<div class="section-title"><span>Constructors Championship · 2026 · After R7 Barcelona</span><span>Tap for breakdown</span></div>`;
