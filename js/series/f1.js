...
const HARDCODED_RACES={
  ...
  9:{round:'9',raceName:'British Grand Prix',date:'2026-07-05',Circuit:{circuitName:'Silverstone Circuit',Location:{country:'🇬🇧'}},
    Results:[
      {position:'1',Driver:{driverId:'leclerc',familyName:'Leclerc',nationality:'Monegasque'},Constructor:{name:'Ferrari'},points:'25',laps:'52',Time:{time:'1:27:11.335'},status:'Finished',FastestLap:{rank:'8',lap:'43',Time:{time:'1:32.871'}}},
      {position:'2',Driver:{driverId:'russell',familyName:'Russell',nationality:'British'},Constructor:{name:'Mercedes'},points:'18',laps:'52',Time:{time:'+0.427'},status:'Finished',FastestLap:{rank:'5',lap:'36',Time:{time:'1:32.489'}}},
      {position:'3',Driver:{driverId:'hamilton',familyName:'Hamilton',nationality:'British'},Constructor:{name:'Ferrari'},points:'15',laps:'52',Time:{time:'+0.772'},status:'Finished',FastestLap:{rank:'4',lap:'25',Time:{time:'1:32.309'}}},
      {position:'4',Driver:{driverId:'norris',familyName:'Norris',nationality:'British'},Constructor:{name:'McLaren'},points:'12',laps:'52',Time:{time:'+1.149'},status:'Finished',FastestLap:{rank:'6',lap:'45',Time:{time:'1:32.625'}}},
      {position:'5',Driver:{driverId:'hadjar',familyName:'Hadjar',nationality:'French'},Constructor:{name:'Red Bull'},points:'10',laps:'52',Time:{time:'+1.598'},status:'Finished',FastestLap:{rank:'3',lap:'40',Time:{time:'1:32.268'}}},
      {position:'6',Driver:{driverId:'lawson',familyName:'Lawson',nationality:'New Zealander'},Constructor:{name:'Racing Bulls'},points:'8',laps:'52',Time:{time:'+2.023'},status:'Finished',FastestLap:{rank:'12',lap:'45',Time:{time:'1:33.648'}}},
      {position:'7',Driver:{driverId:'arvid_lindblad',familyName:'Lindblad',nationality:'British'},Constructor:{name:'Racing Bulls'},points:'6',laps:'52',Time:{time:'+2.214'},status:'Finished',FastestLap:{rank:'11',lap:'29',Time:{time:'1:33.632'}}},
      {position:'8',Driver:{driverId:'bortoleto',familyName:'Bortoleto',nationality:'Brazilian'},Constructor:{name:'Audi'},points:'4',laps:'52',Time:{time:'+2.413'},status:'Finished',FastestLap:{rank:'13',lap:'30',Time:{time:'1:33.650'}}},
      {position:'9',Driver:{driverId:'colapinto',familyName:'Colapinto',nationality:'Argentine'},Constructor:{name:'Alpine F1 Team'},points:'2',laps:'52',Time:{time:'+3.229'},status:'Finished',FastestLap:{rank:'16',lap:'25',Time:{time:'1:34.281'}}},
      {position:'10',Driver:{driverId:'gasly',familyName:'Gasly',nationality:'French'},Constructor:{name:'Alpine F1 Team'},points:'1',laps:'52',Time:{time:'+3.445'},status:'Finished',FastestLap:{rank:'15',lap:'44',Time:{time:'1:34.179'}}},
      {position:'11',Driver:{driverId:'piastri',familyName:'Piastri',nationality:'Australian'},Constructor:{name:'McLaren'},points:'0',laps:'52',Time:{time:'+4.014'},status:'Finished',FastestLap:{rank:'9',lap:'42',Time:{time:'1:32.917'}}},
      {position:'12',Driver:{driverId:'sainz',familyName:'Sainz',nationality:'Spanish'},Constructor:{name:'Williams'},points:'0',laps:'52',Time:{time:'+4.391'},status:'Finished',FastestLap:{rank:'7',lap:'51',Time:{time:'1:32.734'}}},
      {position:'13',Driver:{driverId:'bearman',familyName:'Bearman',nationality:'British'},Constructor:{name:'Haas F1 Team'},points:'0',laps:'52',Time:{time:'+5.245'},status:'Finished',FastestLap:{rank:'17',lap:'31',Time:{time:'1:34.455'}}},
      {position:'14',Driver:{driverId:'ocon',familyName:'Ocon',nationality:'French'},Constructor:{name:'Haas F1 Team'},points:'0',laps:'52',Time:{time:'+5.512'},status:'Finished',FastestLap:{rank:'18',lap:'43',Time:{time:'1:34.792'}}},
      {position:'15',Driver:{driverId:'perez',familyName:'Pérez',nationality:'Mexican'},Constructor:{name:'Cadillac F1 Team'},points:'0',laps:'52',Time:{time:'+7.403'},status:'Finished',FastestLap:{rank:'19',lap:'44',Time:{time:'1:35.520'}}},
      {position:'16',Driver:{driverId:'antonelli',familyName:'Antonelli',nationality:'Italian'},Constructor:{name:'Mercedes'},points:'0',laps:'52',Time:{time:'+8.005'},status:'Finished',FastestLap:{rank:'1',lap:'37',Time:{time:'1:31.777'}}},
      {position:'17',Driver:{driverId:'bottas',familyName:'Bottas',nationality:'Finnish'},Constructor:{name:'Cadillac F1 Team'},points:'0',laps:'52',Time:{time:'+8.162'},status:'Finished',FastestLap:{rank:'21',lap:'31',Time:{time:'1:35.893'}}},
      {position:'18',Driver:{driverId:'alonso',familyName:'Alonso',nationality:'Spanish'},Constructor:{name:'Aston Martin'},points:'0',laps:'51',Time:{time:'+4.980'},status:'Lapped',FastestLap:{rank:'20',lap:'50',Time:{time:'1:35.827'}}},
      {position:'19',Driver:{driverId:'stroll',familyName:'Stroll',nationality:'Canadian'},Constructor:{name:'Aston Martin'},points:'0',laps:'51',Time:{time:'+6.750'},status:'Lapped',FastestLap:{rank:'22',lap:'41',Time:{time:'1:37.232'}}},
      {position:'20',Driver:{driverId:'max_verstappen',familyName:'Verstappen',nationality:'Dutch'},Constructor:{name:'Red Bull'},points:'0',laps:'46',status:'Retired',FastestLap:{rank:'2',lap:'40',Time:{time:'1:32.101'}}},
      {position:'R',Driver:{driverId:'albon',familyName:'Albon',nationality:'Thai'},Constructor:{name:'Williams'},points:'0',laps:'43',status:'Retired',FastestLap:{rank:'14',lap:'42',Time:{time:'1:33.867'}}},
      {position:'R',Driver:{driverId:'hulkenberg',familyName:'Hülkenberg',nationality:'German'},Constructor:{name:'Audi'},points:'0',laps:'36',status:'Retired',FastestLap:{rank:'10',lap:'36',Time:{time:'1:33.433'}}},
    ]}
};
...
const HARDCODED_DRIVER_STANDINGS=[
  {position:'1',points:'179',Driver:{driverId:'antonelli',familyName:'Antonelli',givenName:'Andrea Kimi',nationality:'Italian'},Constructors:[{name:'Mercedes'}]},
  {position:'2',points:'154',Driver:{driverId:'russell',familyName:'Russell',givenName:'George',nationality:'British'},Constructors:[{name:'Mercedes'}]},
  {position:'3',points:'147',Driver:{driverId:'hamilton',familyName:'Hamilton',givenName:'Lewis',nationality:'British'},Constructors:[{name:'Ferrari'}]},
  {position:'4',points:'108',Driver:{driverId:'leclerc',familyName:'Leclerc',givenName:'Charles',nationality:'Monegasque'},Constructors:[{name:'Ferrari'}]},
  {position:'5',points:'97',Driver:{driverId:'norris',familyName:'Norris',givenName:'Lando',nationality:'British'},Constructors:[{name:'McLaren'}]},
  {position:'6',points:'82',Driver:{driverId:'piastri',familyName:'Piastri',givenName:'Oscar',nationality:'Australian'},Constructors:[{name:'McLaren'}]},
  {position:'7',points:'76',Driver:{driverId:'max_verstappen',familyName:'Verstappen',givenName:'Max',nationality:'Dutch'},Constructors:[{name:'Red Bull'}]},
  {position:'8',points:'52',Driver:{driverId:'hadjar',familyName:'Hadjar',givenName:'Isack',nationality:'French'},Constructors:[{name:'Red Bull'}]},
  ...
  {position:'11',points:'20',Driver:{driverId:'arvid_lindblad',familyName:'Lindblad',givenName:'Arvid',nationality:'British'},Constructors:[{name:'Racing Bulls'}]},
  {position:'12',points:'18',Driver:{driverId:'bearman',familyName:'Bearman',givenName:'Oliver',nationality:'British'},Constructors:[{name:'Haas F1 Team'}]},
  {position:'13',points:'18',Driver:{driverId:'colapinto',familyName:'Colapinto',givenName:'Franco',nationality:'Argentine'},Constructors:[{name:'Alpine F1 Team'}]},
  {position:'14',points:'6',Driver:{driverId:'bortoleto',familyName:'Bortoleto',givenName:'Gabriel',nationality:'Brazilian'},Constructors:[{name:'Audi'}]},
...
const HARDCODED_CONSTRUCTOR_STANDINGS=[
  {position:'1',points:'333',Constructor:{name:'Mercedes',nationality:'German'}},
  {position:'2',points:'255',Constructor:{name:'Ferrari',nationality:'Italian'}},
  {position:'3',points:'179',Constructor:{name:'McLaren',nationality:'British'}},
  {position:'4',points:'128',Constructor:{name:'Red Bull',nationality:'Austrian'}},
  {position:'5',points:'60',Constructor:{name:'Alpine F1 Team',nationality:'French'}},
  {position:'6',points:'59',Constructor:{name:'Racing Bulls',nationality:'Italian'}},
  ...
  {position:'9',points:'6',Constructor:{name:'Audi',nationality:'German'}},
